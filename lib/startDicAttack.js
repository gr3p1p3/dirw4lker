 ...
 * @param {Number} [maxConcurrency] - The maximal number of sent parallel asynchronous requests. As default 1000.
 * @returns {Promise<Array>}
 */
async function startDicAttack(options, asyncRequests = false, maxConcurrency = 1000) {
    const ResponseEvent = new (require('./onResponseEvent'))();
